package site.xzwzz.xbar.statusbar
...
import site.xzwzz.xbar.SizeUtils
...
class StatusBarUtil {
    companion object {
        ...
        private var DEFAULT_ALPHA =
            0f//if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) 0.2f else 0.3f;
...
//                    immersive(window, color, alpha)
        ...
        private fun darkModeForOppo(window: Window, darkMode: Boolean) {
        ...
        fun setPaddingSmart(context: Context, view: View) {
            if (Build.VERSION.SDK_INT >= MIN_API) {
                ...
                if (lp != null) {
                    ...
                    if (view.paddingTop < getStatusBarHeight(context)) {
                        view.setPadding(
